...
df = fdr.DataReader(codeNumber, '2022-01-01', '2023-12-31')  # 시작일과 종료일을 원하는 기간으로 설정해야 합니다.
...
si = Stock_indicator(df)

stoDslow, stoKslow = si.calculate_stochastic_slow()

sto_slow = 'Buy' if stoDslow[-1] > stoKslow[-1] else 'Sell'
print(sto_slow)